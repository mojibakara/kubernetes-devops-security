        ...
        stage ('SonarQube - SAST') {
            ...
            steps {
                withSonarQubeEnv('SonarQube') {
                  sh "mvn clean verify sonar:sonar -Dsonar.projectKey=numeric-app -Dsonar.host.url=http://49.12.185.178:9000 -Dsonar.login=sqp_2df78892d01c1917d3ae71dfaf3370c60085568b"
            }
